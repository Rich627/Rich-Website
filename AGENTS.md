...
## Agent workflow calibration

This repo is a single-page static Next.js site with about 10 components. Most tasks
are one- or two-file edits, so do not mechanically delegate a small styling or copy
change. Broad audits and full-repo investigations may still benefit from delegation.
